...
def test_filter_page_markup_can_render_margin_blocks_as_plain_text():
    converter = make_converter(vlm_filter_margin_notes=True)

    markdown = converter._filter_page_markup(
        "Body\n\n<!-- Margin:right id=\"m1\" -->\n> Side note\n> second line\n<!-- /Margin -->"
    )
