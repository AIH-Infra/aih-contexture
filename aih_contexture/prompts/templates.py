...
**示例**：
- 看到 "SC 001" → 输出 `<!-- page-header: SC 001 -->`
- 看到 "SC-001" → 输出 `<!-- page-header: SC-001 -->`
- 看到 "档案号：123" → 输出 `<!-- page-header: 123 -->`
- 看到 "编号 A-2024-001" → 输出 `<!-- page-header: A-2024-001 -->`
...
- 删除线内容：`~~删除的内容~~`
- 插入内容：`^插入的内容^`
- 边注：`> **[Marginal-Left]** 内容` 或 `> **[Marginal-Right]** 内容`
