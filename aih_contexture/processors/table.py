...
from aih_contexture.schema.blocks.tablecell import TableCell
from aih_contexture.schema.document import Document
from aih_contexture.schema.polygon import PolygonBox
from aih_contexture.settings import settings
from aih_contexture.util import matrix_intersection_area, unwrap_math
from aih_contexture.utils.image import is_blank_image
...
class TableProcessor(BaseProcessor):
    ...
    def __call__(self, document: Document):
        ...
        processed_block_ids = {t["block_id"] for t in table_data}
        table_idx = 0
        for page in document.pages:
            for block in page.contained_blocks(document, self.block_types):
