...
def build_vlm_specialized_config(
    ...
    *,
    ...
    config: dict[str, Any] = {
        ...
        "final_output_formats": list(output_formats),
        "ocr_concurrency": _fallback(values.get("ocr_concurrency"), 5),
        "ocr_batch_size": _fallback(values.get("ocr_batch_size"), 10),
        ...
        "ocr_max_tokens": _fallback(values.get("ocr_max_tokens"), default_max_tokens),
