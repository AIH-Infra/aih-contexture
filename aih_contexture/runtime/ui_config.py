...
def vlm_specialized_cli_config(config_params: dict[str, Any]) -> dict[str, Any]:
    ...
    cli = {
        ...
        "ocr_concurrency": _int_param(config_params, "ocr_concurrency", 5),
        "ocr_batch_size": _int_param(config_params, "ocr_batch_size", 10),
...
def layout_backend_cli_config(layout_backend: str, config_params: dict[str, Any]) -> dict[str, Any]:
    ...
    if layout_backend == "mineru_pp_doclayout_v2":
        config = mineru_layout_fields(config_params, include_external_mapping=True)
        config["mineru_timeout"] = _int_param(config_params, "mineru_timeout", 3600)
        return config
